...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2020 at 08:05 AM
...
CREATE TABLE `videos` (
  ...
  `watermark` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL,
