        ...
        <form id="signupForm" action="/user/sign-up" method="post">
            ...
            <div class="p-lg panel md-whiteframe-z1 text-color m">
                ...
                <?php if(isset($success)): ?>
                    <div id="alert-message" class="alert alert-success"><?php echo e($success); ?></div>
                <?php endif; ?>
...
<?php /**PATH E:\Image\website\batman\app\Modules/User/resources/views/signup.blade.php ENDPATH**/ ?>